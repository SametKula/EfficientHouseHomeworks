...
public class TaxFactory {
    ...
    public static PideSaloon create(PideSaloon pideci, String name, double pideRatioByhour, int workers, int popularity) {
        pideci.name = name;
        pideci.cookingPideRatio = pideRatioByhour;
        pideci.workerCount = workers;
        pideci.popularity = popularity;
        pideci.taxNumber = taxNameCreate();
